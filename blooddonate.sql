...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 25, 2018 at 09:19 PM
...
(767, 'Mahbubur Rahman', 'Mahbub', 'mahbubhabib@ymail.com', 'O(Positive)', 'Dhaka', 'male', '2016-08-04', 1673595182, 'Hello How r u?', ''),
...
(770, 'Adbullah Mamun Prince vai :P', 'Mamun', 'mamun@gmail.com', 'AB(Positive)', 'Khulna', 'female', '2016-06-12', 176545669, '', ''),
(771, 'Khairul Kahbir', 'Kabir', 'k@gmail.com', 'O(Negative)', 'Rajshahi', 'male', '2015-09-25', 1578326987, 'Can U donate blood now?', 'Yes,I can.Where?'),
(772, 'Shakil Akondo', 'Shakil', 'shakil@gmail.com', 'AB(Negative)', 'Sylhet', 'male', '0000-00-00', 1673549852, '', '');
...
(768, 'Shakil', 'Shakil12', 1, 0),
(770, 'admin', 'admin123', 0, 1);
...
--
ALTER TABLE `login`
  MODIFY `login_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=771;
